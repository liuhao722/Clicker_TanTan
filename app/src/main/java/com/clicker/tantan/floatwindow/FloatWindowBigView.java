package com.clicker.tantan.floatwindow;
...
import com.clicker.tantan.utils.CmdUtils;
...
//                } else {
//                    Toast.makeText(context, "程序运行中，先点击停止工具，再进行打开工具", Toast.LENGTH_LONG).show();
//                    MyWindowManager.removeBigWindow(context);
//                    MyWindowManager.createSmallWindow(context);
//                }
            }
    ...
    private void disMiss(Context context, boolean stop) {
        ...
        MyWindowManager.removeBigWindow(context);
        MyWindowManager.createSmallWindow(context);
        CmdUtilsTanTan.ins().stopCMD(context, stop);
    }
}
